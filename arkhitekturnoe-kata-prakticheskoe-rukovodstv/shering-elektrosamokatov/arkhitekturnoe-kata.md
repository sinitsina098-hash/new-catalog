...
-  **Reporting Service** \- используется для хранения истории поездок, построения отчетов для бизнеса и анализа данных. Он подписывается на все события, связанные с завершенными поездкам
...
<mermaid path="./arkhitekturnoe-kata-2.mermaid" width="780px" height="121px"/>
